using BotSharp.Plugin.LiteDBStorage.Models;
...
public class AgentDocument : LiteDBBase
{
    ...
    public List<AgentUtilityLiteDBElement> Utilities { get; set; }
    public List<AgentKnowledgeBaseLiteDBElement> KnowledgeBases { get; set; }
    public List<string> Profiles { get; set; }
    public List<string> Labels { get; set; }
    public List<RoutingRuleLiteDBElement> RoutingRules { get; set; }
    public List<AgentRuleLiteDBElement> Rules { get; set; }
