...
public partial class RoutingService : IRoutingService
{
    ...
    public async Task<RoleDialogModel> InstructDirect(Agent agent, RoleDialogModel message, List<RoleDialogModel> dialogs, Func<RoleDialogModel, Task> onStreamResponseReceived)
    {
